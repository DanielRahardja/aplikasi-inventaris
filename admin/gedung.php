<div class="content">
    <h1><i class="fa-solid fa-building fa-sm mr-2"></i>Input Data Gedung</h1>
    <!-- Row -->
    <div class="row">
      <div class="col-8 mr-5">
          <!-- Button -->
          <div class="btn-group" role="group" aria-label="Basic example">
          <button type="button" class="btn btn-primary mb-5 mt-2" data-toggle="modal" data-target="#tambahGedung">
    ...
    <div class="table-responsive">
      ...
      <?php 
              ...
              $fetchdata=mysqli_query($koneksi,"Select * from gedung where namaGedung like '%$keyword%'");
              //Pagination Config
              $jumlahdata=5;
              ...
              //End Config
              $fetchdata_limit= mysqli_query($koneksi,"Select * from gedung where namaGedung like '%$keyword%' limit $awalan,$jumlahdata");
      ...
      <tbody>
          <tr>
              ...
              <td>
                  <a class="btn btn-danger" href="hapusgedung.php?idGedung=<?php echo $data['idGedung'];?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')"  >
...
<!-- Modals -->
<!-- Modal Insert -->
<div class="modal fade" id="tambahGedung" tabindex="-1" role="dialog" aria-labelledby="tambahGedungLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="tambahGedungLabel">Tambah Data Gedung</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <form action="tambahgedung.php" method="POST">
        <div class="form-group">
          <label for="namaGedung">Nama Gedung</label>
          <input type="text" class="form-control" id="namaGedung" name="namaGedung" placeholder="Masukkan nama gedung">
        </div>
