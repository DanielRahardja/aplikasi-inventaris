...
<div class="container">
    <div class="content">
        ...
        <div class="row ml-1">
            <div class="card bg-primary text-white" style="width: 15rem;">
                <div class="card-body">
                    ...
                    <div class="display-4"><?php echo $totPegawai; ?></div>
                </div>
            </div>
            <div class="card bg-success text-white ml-2" style="width: 15rem;">
                <div class="card-body">
                    ...
                    <div class="display-4"><?php echo $totSupplier; ?></div>
                </div>
            </div>
            <div class="card bg-info text-white ml-2" style="width: 15rem;">
                <div class="card-body">
                    <div class="card-body-icon">
                        <i class="fa-solid fa-users mr-2"></i>
                    </div>
                    <h5 class="card-title">Total Akun</h5>
                    <div class="display-4"><?php echo $totAkun; ?></div>
                </div>
            </div>
            <div class="card bg-secondary text-white ml-2" style="width: 15rem;">
                <div class="card-body">
                    <div class="card-body-icon">
                        <i class="fa-solid fa-person-shelter mr-2"></i>
                    </div>
                    <h5 class="card-title">Total Ruangan</h5>
                    <div class="display-4"><?php echo $totRuang; ?></div>
                </div>
            </div>
        </div>
        <!-- End Row -->
        ...
        <!-- End Row -->
        <!-- Row Barang masuk-rusak -->
        <div class="row ml-1">
            <!-- Barang Masuk,Baik dan Rusak -->
            <div class="card bg-warning text-white mt-2" style="width: 18rem;">
                <div class="card-body">
                    <div class="card-body-icon">
                        <i class="fa-solid fa-boxes-packing mr-2"></i>
                    </div>
            ...
            <div class="card bg-danger text-white mt-2 ml-2" style="width: 18rem;">
                <div class="card-body">
                    <div class="card-body-icon">
                        <i class="fa-solid fa-thumbs-down mr-2"></i>
                    </div>
                    <h5 class="card-title">Total Barang Rusak</h5>
                    <div class="display-4"><?php echo $totRusak; ?></div>
                </div>
            </div>
        </div>
        <!-- End Row -->
