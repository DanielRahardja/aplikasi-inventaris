...
<div class="container">
  <div class="content">
      <h1>Kelola Kategori Barang</h1>
      <!-- Row -->
      <div class="row">
          <div class="col-8 mr-5">
              <!-- Button -->
              <div class="btn-group" role="group" aria-label="Basic example">
              <button type="button" class="btn btn-primary mb-5 mt-2" data-toggle="modal" data-target="#tambahKategori">
      ...
      <div class="table-responsive">
        ...
        <table class="table">
          ...
          $fetchdata=mysqli_query($koneksi,"Select * from kategoribarang where namaKategori like '%$keyword%'");
          //Pagination Config
          $jumlahdata=5;
          ...
          //End Config
          $fetchdata_limit= mysqli_query($koneksi,"Select * from kategoribarang where namaKategori like '%$keyword%' limit $awalan,$jumlahdata");
          ...
          <tbody>
              <tr>
                  ...
                  <td>
                      <a class="btn btn-danger" href="hapuskategori.php?idKategori=<?php echo $data['idKategori'];?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')"  >
    ...
    <div class="row">
      <div class="col-8">
        <!-- Quotes -->
          <span>Catatan: Data-data kategori ini akan otomatis ditambahkan ke pemilihan kategori di bagian penambahan data barang</span>
      </div>
      <div class="col-2">
        <!-- Pagination -->
