<div class="container">
    <div class="content">
    <h1>Data Inventaris: Pengembalian Barang</h1>
    <!-- Row -->
    <div class="row">
    ...
    <?php 
          ...
          $fetchdata=mysqli_query($koneksi,"Select * from kembali where peminjam like '%$keyword%'");
          //Pagination Config
          $jumlahdata=5;
          ...
          //End Config
          $fetchdata_limit= mysqli_query($koneksi,"Select * from kembali where peminjam like '%$keyword%' limit $awalan,$jumlahdata");
    ...
    <tbody>
        <tr>
            ...
            <td><?php echo $data['jumlahKembali']; ?></td>
