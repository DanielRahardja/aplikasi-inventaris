...
<head>
    ...
    <title>Aplikasi Inventaris- Operator</title>
    <!-- Asset Setup -->
    <!-- Panggil CSS -->
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="?url=inventaris">Data Inventaris<i class="fa-solid fa-truck-arrow-right fa-sm ml-1"></i></a>
                        </div>
                    </li>
                </ul>
                        ...
                        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="navbarDropdown" style="margin-left: -200px;">
                            <table>
                                ...
                                <?php 
                                    ...
                                    <label class="bg-warning text-white">Stok <?php echo $dataStok['namaBarang']; ?> sisa <?php echo $dataStok['stok']; ?></label>
                                    <?php }?>
                                </tr>
                                <?php } ?>
                            </table>
        ...
        <?php
            if (isset($_GET['url'])) {
                ...
                elseif ($_GET['url']=="inventaris") {
                    include 'operator/inventaris.php';
                }elseif ($_GET['url']=="pinjam") {
                    include 'operator/peminjaman.php';
                }elseif ($_GET['url']=="kembali") {
                    include 'operator/pengembalian.php';
                }
