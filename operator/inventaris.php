<div class="container">
   ...
   <h1>Data Inventaris</h1>
    ...
    <div class="row">
      <div class="col-8 mr-5">
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
          ...
          <a class="btn btn-success ml-2 mb-5 mt-2" href="?url=pinjam">Data Peminjaman<i class="fa-solid fa-database ml-1"></i></a>
          <a class="btn btn-success ml-2 mb-5 mt-2" href="?url=kembali">Data Pengembalian<i class="fa-solid fa-database ml-1"></i></a>
        </div>
      </div>
      <div class="col mb-2">
    ...
    <?php 
          ...
          $fetchdata=mysqli_query($koneksi,"Select * from inventaris where peminjam like '%$keyword%'  or statuspeminjaman like '%$keyword%'");
          //Pagination Config
          $jumlahdata=5;
          ...
          //End Config
          $fetchdata_limit= mysqli_query($koneksi,"Select * from inventaris where peminjam like '%$keyword%'  or statuspeminjaman like '%$keyword%' limit $awalan,$jumlahdata");
    ...
    <tbody>
        <tr>
            ...
            <td>
              ...
              ?>
                  <label class='text-warning'><?php echo $data['statuspeminjaman']; ?></label>
              <?php
                }elseif ($data['statuspeminjaman']== 'Selesai') { ?>
                  <label class='text-success'><?php echo $data['statuspeminjaman']; ?></label>
              <?php 
                }elseif ($data['statuspeminjaman']== 'Terlambat') {
                  # code...
              ?>
              <label class='text-danger'><?php echo $data['statuspeminjaman']; ?></label>
              <?php } ?>
            </td>
    ...
    <div class="row">
          <div class="col-9">
            <caption>
              ...
              <label class="text-warning">Sedang Dipinjam</label>: Peminjam Sedang meminjamkan barang <br>
              <label class="text-success">Selesai</label>: Peminjam telah mengembalikan barang.<br>
              <label class="text-danger">Terlambat</label>: Peminjam terlambat mengembalikan barang.<br>
            </caption>
          </div>
          <div class="col">
            <!-- Pagination -->
